...
const OtherSetting = () => {
  ...
  const openGitHubRelease = () => {
    window.location = 'https://github.com/bustesoul/done-hub/releases/latest';
  };
  ...
  const checkUpdate = async () => {
    try {
      ...
      if (import.meta.env.VITE_APP_VERSION.startsWith('v')) {
        const res = await API.get('https://api.github.com/repos/bustesoul/done-hub/releases/latest');
        ...
        const res = await API.get('https://api.github.com/repos/bustesoul/done-hub/commits/main');
